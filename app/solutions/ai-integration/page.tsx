      ...
      <main className="relative flex-1 flex flex-col z-10 pt-32 pb-24">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-12 w-full mb-24">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-5xl md:text-8xl font-bold tracking-tighter text-white uppercase italic leading-[0.85] mb-10">
              AI <br /> Integration.
            </h1>
          ...
          <div className="space-y-12">
            <div className="p-8 rounded-[32px] bg-white/5 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white uppercase italic tracking-tight">Data Ingestion</h3>
              </div>
            ...
            <div className="p-8 rounded-[32px] bg-white/5 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white uppercase italic tracking-tight">Security & Privacy</h3>
              </div>
              <p className="text-base font-semibold text-zinc-400 leading-relaxed">
          ...
          <div className="space-y-12">
            <div className="p-8 rounded-[32px] bg-white/5 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white uppercase italic tracking-tight">API & Middleware</h3>
              </div>
              <p className="text-base font-semibold text-zinc-400 leading-relaxed">
            ...
            <div className="p-8 rounded-[32px] bg-white/5 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-white uppercase italic tracking-tight">Legacy Connectivity</h3>
              </div>
              <p className="text-base font-semibold text-zinc-400 leading-relaxed">
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-12 w-full mb-24">
           <div className="relative rounded-[40px] border border-white/10 bg-white/5 p-12 overflow-hidden flex flex-col items-center text-center">
             <div className="bg-zinc-900 rounded-[32px] p-8 md:p-12 shadow-sm border border-white/10 max-w-2xl w-full">
               ...
               <h3 className="text-xl font-bold text-white uppercase italic mb-4">Unified AI Architecture</h3>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-12 w-full mb-32">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold uppercase italic tracking-tighter text-white leading-[0.9]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="relative p-6 rounded-3xl border border-white/5 bg-white/5 group hover:border-[#7C5CFC] transition-all duration-500">
                ...
                <h4 className="text-lg font-bold uppercase italic text-white mb-2">{s.label}</h4>
