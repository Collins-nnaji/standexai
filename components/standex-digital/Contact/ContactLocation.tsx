        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-1 gap-4 mb-12">
              ...
              <a href="https://linkedin.com/company/standex-digital" className="flex items-center gap-4 group p-4 rounded-2xl border border-zinc-100 hover:border-[#7C5CFC] transition-all">
                <div className="h-10 w-10 flex items-center justify-center rounded-xl bg-zinc-50 border border-zinc-100 group-hover:bg-[#7C5CFC]/10 transition-colors">
