    ...
    <div className="w-full bg-zinc-950 py-16 px-4">
      <div ref={sectionRef} className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <h3 className="text-[#7C5CFC] font-medium mb-3">The Future Of Business Efficiency</h3>
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight mb-6">What is Power Automate?</h2>
            ...
            <ul className="space-y-4 mb-8">
              ...
              >
                <div className="text-[#7C5CFC] mr-2 mt-1 text-xl">•</div>
                <p className="text-zinc-400">
                  <span className="font-medium text-[#7C5CFC]">Seamless connections:</span> Integrate all of your essential software and data systems 
                  with ease.
                </p>
              </li>
              <li 
              ...
              >
                <div className="text-[#7C5CFC] mr-2 mt-1 text-xl">•</div>
                <p className="text-zinc-400">
                  <span className="font-medium text-[#7C5CFC]">Work from anywhere:</span> Manage workflows on the go with the Power Automate 
                  mobile app.
                </p>
              </li>
            </ul>
